...
set_property -dict {PACKAGE_PIN K6 IOSTANDARD LVCMOS18} [get_ports s0]
set_property -dict {PACKAGE_PIN J6 IOSTANDARD LVCMOS18} [get_ports s1]
set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS18} [get_ports out]