...
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS18} [get_ports C_IN]
set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS18} [get_ports SUM[3]]
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS18} [get_ports SUM[2]]
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS18} [get_ports SUM[1]]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS18} [get_ports SUM[0]]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS18} [get_ports C_OUT]