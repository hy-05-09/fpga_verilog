...
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS18} [get_ports y]
set_property -dict {PACKAGE_PIN K3 IOSTANDARD LVCMOS18} [get_ports z]
set_property -dict {PACKAGE_PIN M2 IOSTANDARD LVCMOS18} [get_ports w]
