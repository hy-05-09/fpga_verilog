...
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS18} [get_ports b0]
set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS18} [get_ports D[3]]
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS18} [get_ports D[2]]
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS18} [get_ports D[1]]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS18} [get_ports D[0]]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS18} [get_ports b4]