...
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS18} [get_ports C0]
set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS18} [get_ports S[3]]
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS18} [get_ports S[2]]
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS18} [get_ports S[1]]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS18} [get_ports S[0]]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS18} [get_ports C4]